...
exports.createMeasurements = function(options, doneCreateMeasurements){
	...
	// each parameter
  async.each(parameters, function(parameter, doneEachParameter){
		// each measurement
  	async.times(measurementsCount, function(n, doneEachMeasurement){
			var hoursAgo = n * options.interval;
      self.createMeasurement(options.sensor, parameter, hoursAgo, doneEachMeasurement);
    }, doneEachParameter);
